...
function generateSessionId(provider: string): string {
 ...
 */
export async function createStableLinkPayment(params: CreatePaymentParams): Promise<PaymentSession> {
  ...
  try {
    ...
    const data = await response.json() as { payment_id?: string; checkout_url?: string };
 ...
 */
export async function createPayPalPayment(params: CreatePaymentParams): Promise<PaymentSession> {
 ...
 */
export async function createStripePayment(params: CreatePaymentParams): Promise<PaymentSession> {
 ...
 */
export async function createCoinbasePayment(params: CreatePaymentParams): Promise<PaymentSession> {
