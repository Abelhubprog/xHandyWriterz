# 📚 Documentation Index - Railway Strapi Login Fix
...
> Canonical product/architecture docs now live in `docs/NEW/`. Use this index only for historical Railway login fix context.
...
#### "Set up a new Railway deployment"
